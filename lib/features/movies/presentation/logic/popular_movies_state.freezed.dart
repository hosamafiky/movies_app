...
class _Loading implements PopularMoviesState {
  const _Loading();
...
class _Success implements PopularMoviesState {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $PopularMoviesStateCopyWith<$Res> {
...
class _Error implements PopularMoviesState {
...
@override
String toString() {
  return 'PopularMoviesState.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $PopularMoviesStateCopyWith<$Res> {
